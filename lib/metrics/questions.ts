...
/** 要求解釋原因、機制。 */
const WHY = ["為什麼", "為何", "怎麼會", "原因是", "理由是", "憑什麼"];

/** 要求比較、區辨。 */
const COMPARE = ["差別", "差在哪", "比較好", "哪一個比較", "不一樣的地方", "有什麼不同", "哪裡不同"];
...
/** 要求方法、策略，而不是成品。 */
const HOW = ["怎麼做", "怎麼寫比較", "怎麼樣才能", "如何才能", "有什麼方法", "該從哪", "要注意什麼"];

/** 追問、深化前一輪。 */
const PROBE = ["那如果", "可是", "還有別的", "還有其他", "再多說", "更具體", "舉個例", "舉例說明"];
